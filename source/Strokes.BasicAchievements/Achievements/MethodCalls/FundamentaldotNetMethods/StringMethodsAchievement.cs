...
{
    [AchievementDescription("{76417EFA-1E80-45B5-A0A4-C065DD1E1649}", "@StringCompareAchievementName",
    ...
    [AchievementDescription("{FE01CF1A-6E39-4624-8FCD-9F104ACD40D8}", "@StringConcatAchievementName",
    ...
    [AchievementDescription("{106C10A9-8F87-49CC-8D61-7F233856CD49}", "@StringCopyAchievementName",
    ...
    [AchievementDescription("{AC08974F-9E7A-4B41-B778-D091789078F2}", "@StringEqualsAchievementName",
    ...
    [AchievementDescription("{8C873AF8-BDEE-4793-ABC2-57449B109A7E}", "@StringJoinAchievementName",
