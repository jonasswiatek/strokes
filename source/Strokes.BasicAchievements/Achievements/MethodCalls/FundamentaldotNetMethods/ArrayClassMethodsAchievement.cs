...
{
    [AchievementDescription("{FAB140C9-B951-4600-BCCB-CE0AD93419D8}", "@ArrayClearMethodAchievementName",
    ...
    [AchievementDescription("{F54D457D-8A8D-44C7-81AC-2E66FD894F25}", "@ArrayIndexOfMethodAchievementName",
    ...
    [AchievementDescription("{7C801797-1B66-41D8-A658-FCE84929D1CA}", "@ArrayReverseMethodAchievementName",
    ...
    [AchievementDescription("{282C5488-C7CC-43E7-9F81-D44354B0794D}", "@ArraySortMethodAchievementName",
