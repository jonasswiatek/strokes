...
{
    [AchievementDescription("{3793453C-C67F-4241-B714-D1D0DC580BA1}", "@UpperBoundaryValueFloatName",
    ...
    [AchievementDescription("{A23BC188-DBB1-4D36-B30A-DEF9FCED1ECF}", "@LowerBoundaryValueFloatName",
