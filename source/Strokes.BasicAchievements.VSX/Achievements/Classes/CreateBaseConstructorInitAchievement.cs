...
{
    [AchievementDescription("Call base", AchievementDescription = "Call another base constructor using the base() keyword from a constructor", AchievementCategory = "Basic Achievements")]
